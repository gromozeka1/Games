...
public class StateString
{
    ...
    {
        bool castleWKS = board.CatleRightKingSide(Player.White);
        bool castleWQS = board.CatleRightQueenSide(Player.White);

        bool castleBKS = board.CatleRightKingSide(Player.Black);
        bool castleBQS = board.CatleRightQueenSide(Player.Black);
